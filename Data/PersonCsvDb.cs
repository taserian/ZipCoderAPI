...
{
    public class PersonCsvDb: IPersonRepository
    {
        public List<Person> persons;
        public IStateMatcher stateMatcher;

        public PersonCsvDb(IStateMatcher matcher) {
            stateMatcher = matcher;
            string pathToCsv = Directory.GetCurrentDirectory() + Path.DirectorySeparatorChar + "MOCK_DATA.csv";
